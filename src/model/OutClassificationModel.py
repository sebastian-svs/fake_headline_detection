...
class OutClassificationModel():
    def __init__(
        ...
        MODEL_CLASSES = {
            ...
            "deberta-v3": (DebertaV2Config, DebertaV2ForSequenceClassification, DebertaV2Tokenizer),  # NEUE ZEILE
    ...
    def load_and_cache_examples(
        ...
        if output_mode == "classification":
            ...
            features_array = np.array([f.feature for f in features])
            all_feature = torch.tensor(features_array, dtype=torch.float)
